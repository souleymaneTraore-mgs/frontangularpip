...
NgbDatepickerMonth.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.2", ngImport: i0, type: NgbDatepickerMonth, deps: [{ token: i3.NgbDatepickerI18n }, { token: NgbDatepicker }, { token: i9.NgbDatepickerKeyboardService }, { token: i1.NgbDatepickerService }], target: i0.ɵɵFactoryTarget.Component });
